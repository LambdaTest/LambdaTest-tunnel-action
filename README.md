# Automate Local Tests With TestMu AI (Formerly LambdaTest) Tunnel
...
With TestMu AI (Formerly LambdaTest) Tunnel, you can automate local tests by securely exposing your locally hosted apps to the TestMu AI (Formerly LambdaTest) cloud.
